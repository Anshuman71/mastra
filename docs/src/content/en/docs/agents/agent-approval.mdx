...
You can also decline tool calls at the supervisor level by calling [`declineToolCall`](/reference/streaming/agents/stream). The supervisor will respond acknowledging the declined tool without executing it:
