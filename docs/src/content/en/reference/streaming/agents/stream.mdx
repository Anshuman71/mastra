...
This example demonstrates using the supervisor pattern features for coordinating subagents with intelligent monitoring and control.
  ...
  'Research AI in education and provide recommendations',
  {
    ...
    delegation: {
      ...
      onDelegationStart: async context => {
        ...
        // Add extra instructions for specific subagents
