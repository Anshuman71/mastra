...
isOptional: true,
description:
  "Configuration for sub-agent delegation. Use this to control and monitor when the agent delegates tasks to other agents, including the ability to modify, reject, or bail out of delegations.",
properties: [
  {
    parameters: [
      {
    ...
    parameters: [
      {
        ...
        isOptional: true,
        description: "Called after a sub-agent delegation completes. Use this to process the result or call context.bail() to stop further execution.",
      },
    ],
  },
  {
